...
class MasterClassForm(FlaskForm):
    ...
    description_private = TextAreaField(
        ...
        validators=[
            Optional(),
            Length(max=2000, message="La descripción privada no puede exceder 2000 caracteres")
        ],
    ...
    date = DateField(
        "Fecha del Evento",
        validators=[DataRequired(message="La fecha del evento es requerida")],
        format='%Y-%m-%d'
    )
    
    start_time = TimeField(
        "Hora de Inicio",
        validators=[DataRequired(message="La hora de inicio es requerida")],
        format='%H:%M'
    )
    
    end_time = TimeField(
        "Hora de Fin",
        validators=[DataRequired(message="La hora de fin es requerida")],
        format='%H:%M'
    )
