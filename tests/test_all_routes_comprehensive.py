...
class TestComprehensiveRoutes:
    ...
    def test_static_routes_anonymous_user(self, full_db_setup_with_examples):
        ...
        with app.test_client() as client:
            ...
            # Report any failures
            if failed_routes:
                pytest.fail(f"Routes with server errors:\n" + "\n".join(failed_routes))
    ...
    def test_dynamic_routes_with_sample_data(self, full_db_setup_with_examples):
        ...
        with app.test_client() as client:
            ...
            if server_errors:
                pytest.fail(f"Dynamic routes with server errors:\n" + "\n".join(server_errors))
    ...
    def test_error_handling_routes(self, full_db_setup_with_examples):
        ...
        with app.test_client() as client:
            ...
            # Report any failures
            if failed_routes:
                pytest.fail(f"Error handling routes failed:\n" + "\n".join(failed_routes))
    ...
    def test_common_public_routes(self, full_db_setup_with_examples):
        ...
        with app.test_client() as client:
            ...
            # Report any failures
            if failed_routes:
                pytest.fail(f"Public routes failed:\n" + "\n".join(failed_routes))