        ...
        with full_db_setup_with_examples.test_client() as client:
            for ruta in rutas_estaticas:
                ...
                try:
                    ...
                    assert consulta.status_code == ruta.no_session, f"Route {route} returned {consulta.status_code}, expected {ruta.no_session}"
        ...
        with full_db_setup.test_client() as client:
            ...
            for ruta in rutas_estaticas:
                ...
                try:
                    ...
                    assert consulta.status_code == ruta.admin, f"Route {ruta.ruta} returned {consulta.status_code}, expected {ruta.admin}"
